...
import { useIsMobile } from "@nxss/ui/hooks/use-mobile";
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@nxss/ui/tooltip";

const SIDEBAR_COOKIE_NAME = "sidebar_state";
const SIDEBAR_COOKIE_MAX_AGE = 60 * 60 * 24 * 7;
const SIDEBAR_WIDTH = "15.2rem";
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "flex h-full flex-col bg-sidebar text-sidebar-foreground [width:var(--sidebar-width)]",
          className,
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar p-0 text-sidebar-foreground [width:var(--sidebar-width)] [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative bg-transparent transition-[width] duration-200 ease-linear [width:var(--sidebar-width)]",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] duration-200 ease-linear [width:var(--sidebar-width)] md:flex",
          side === "left"
